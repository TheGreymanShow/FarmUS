...
public class BackgroundTask extends AsyncTask<String,Void,String> {
    ...
    String Register_url = "http://192.168.1.3/farmus/Admin_form/registerapp.php";
    Context context;
    Activity activity;
    AlertDialog.Builder builder;
    ProgressDialog progressDialog;
    String msg = "Thank you for writing to us.We will get back to you !";
