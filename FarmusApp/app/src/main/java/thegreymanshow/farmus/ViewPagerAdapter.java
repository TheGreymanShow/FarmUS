...
/**
 * Created by akshay dangare on 1/28/2017.
 */
...
public class ViewPagerAdapter extends FragmentPagerAdapter implements ViewPager.OnPageChangeListener {
    ...
    int[] icons = new int[]{R.drawable.ic_home2,R.drawable.ic_events2,R.drawable.ic_show2,R.drawable.ic_contactus2};
    int[] iconsSelected = new int[]{R.drawable.ic_home,R.drawable.ic_events,R.drawable.ic_show,R.drawable.ic_contactus};
    Context context;
    TabLayout tabLayout;
    ViewPager viewPager;
